...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-11 border p-4 px-5" style="min-height: 500px">
            <div class="row px-5">
                <form class="row g-3 needs-validation px-5" action="/customer?action=edit" method="post" novalidate>
                    <div class="col-md-12 py-2">
                        <label for="validationCustom01" class="form-label">Id Customer</label>
                        <input type="text" class="form-control" value="<c:out value='${customer.customerCode}'/>"
                               name="id" id="validationCustom01" placeholder="Id Customer" required>
                    ...
                    <div class="col-md-6 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.firstName}'/>"
                               name="first name" id="validationCustom02" placeholder="last name" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-6 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.lastName}'/>"
                               name="last name" id="validationCustom03" placeholder="last name" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-12 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.dateOfBirth}'/>"
                               name="birthday" id="validationCustom06" placeholder="Customer birthday" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-12 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.identityCardNumber}'/>"
                               name="id card" id="validationCustom07" placeholder="Customer id card" required>
                    ...
                    <div class="col-md-12 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.telephoneNumber}'/>"
                               name="phone" id="validationCustom05" placeholder="Customer phone" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-12 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.email}'/>" name="email"
                               id="validationCustom011" placeholder="Customer email" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-12 py-2">
                        ...
                        <input type="text" class="form-control" value="<c:out value='${customer.address}'/>"
                               name="address" id="validationCustom012" placeholder="Customer salary" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
